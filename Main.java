...
public class Main {
	...
	private static String[] defaultElementNames = {"hydrogen","helium","lithium","beryllium","boron","carbon",
		...
		"darmstadtium","roentgenium","ununbium","ununtrium","ununquadium","ununpentium","ununhexium",
		"ununseptium","ununoctium"};
	
	
	private static ArrayList<String> elementSymbol = new ArrayList<String>();
	private static String[] defaultElementSymbols = {"h","he","li","be","b","c","n","o","f","ne","na","mg","al","si","p","s",
		...
		"ir","pt","au","hg","tl","pb","bi","po","at","rn","fr","ra","ac","th","pa","u","np","pu","am","cm",
		"bk","cf","es","fm","md","no","lr","rf","db","sg","bh","hs","mt","ds","rg","uub","uut","uuq","uup",
		"uuh","uus","uuo"};
	
	public static void calc(boolean isShift)
	{
		Collections.addAll(elementNames, defaultElementNames);
		Collections.addAll(elementSymbol, defaultElementSymbols);
		int electrons = 0;
		boolean flag = true;
		if(elementNames.contains(textInput.getText().toLowerCase()))
		{
			flag = false;
			electrons = elementNames.indexOf(textInput.getText().toLowerCase());
		}
		if(elementSymbol.contains(textInput.getText().toLowerCase()))
		{
			flag = false;
			electrons = elementSymbol.indexOf(textInput.getText().toLowerCase());
		}
		if(flag)
		{
			try
